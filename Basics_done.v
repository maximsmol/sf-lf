...
Fixpoint bin_to_nat (n : bin) : nat :=
  ...
  | Z => 0
  | D n' => bin_to_nat n' * 2
  | M n' => bin_to_nat n' * 2 + 1
  end.

Example test_incr1: incr (M (D (D (M Z)))) = (D (M (D (M Z)))).
Proof. simpl. reflexivity. Qed.

Example test_incr2: incr (M (M Z)) = (D (D (M Z))).
Proof. simpl. reflexivity. Qed.

Example test_incr3: incr (M (M (M Z))) = (D (D (D (M Z)))).
Proof. simpl. reflexivity. Qed.


Example test_bin_to_nat1: bin_to_nat (M (D (D (M Z)))) = 9.
Proof. simpl. reflexivity. Qed.

Example test_bin_to_nat2: bin_to_nat (D (M (D (M Z)))) = 10.
Proof. simpl. reflexivity. Qed.

Example test_bin_to_nat3: bin_to_nat (D (D (D (M Z)))) = 8.
Proof. simpl. reflexivity. Qed.
